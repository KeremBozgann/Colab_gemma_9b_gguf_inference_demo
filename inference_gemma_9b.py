"""
Quantized inference script for Gemma 9B on Colab T4.
Edit the settings below and run: python inference_gemma_9b.py
"""
...
# === Settings ===
CHECKPOINT = "ytu-ce-cosmos/Turkish-Gemma-9b-v0.1"
MESSAGES = [
    {
        "role": "system",
        "content": (
